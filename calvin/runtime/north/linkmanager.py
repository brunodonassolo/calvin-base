...
class Link(object):
    ...
    def __init__(self, actor_src_id, actor_dst_id, requirements):
        self.links = {}
...
class LinkManager(object):
    ...
    def new(self, actor_src_id, actor_dst_id, requirements):
        """
        ...
        self.links[id] = Link(actor_src_id, actor_dst_id, requirements)
